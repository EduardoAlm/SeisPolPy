...
class PinnegarMethod:
    ...
    def pinnegar(data, s=100):
        ...
        tfrx = PinnegarMethod.stft(sig[1][0:(half)], s)  # R component vector 
        tfry = PinnegarMethod.stft(sig[0][0:(half)], s)  # T component vector 
        tfrz = PinnegarMethod.stft(sig[2][0:(half)], s)  # Z component vector 
