...
def amplitude(zeta, eta, eig_values):
    ...
    if eig_values[2] >= 0 and eig_values[2] < zeta:
        ...
        ampli = cos(pi*(eig_values[2]-zeta)/2*(eta-zeta))
...
def rstfr(data, alg="stft",filt="love", s=100, n_it=400, alpha=0.1, beta=0.12, gamma=0.25, lamb_da=0.3, zeta=0.26, eta=0.23):
    ...
    if filt=="love":
        ...
        ext_love_filter = multiply((1 - rec_filter), (1 - dir_love_filter), (1 - amp_filter))
        ...
        ext_rayleigh_filter = multiply((1 - rec_filter), (1 - dir_rayleigh_filter), (1 - amp_filter))
